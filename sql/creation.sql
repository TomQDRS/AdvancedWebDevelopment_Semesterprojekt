...
CREATE TABLE `awd_projekt`.`user` ( `ID` INT NOT NULL AUTO_INCREMENT , `USERNAME` VARCHAR(42) NOT NULL , `EMAIL` VARCHAR(255) NOT NULL , `PASSWORD` VARCHAR(255) NOT NULL , `REGISTERED_ON` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`ID`), UNIQUE (`USERNAME`), UNIQUE (`EMAIL`)) ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_general_ci;
